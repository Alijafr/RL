...
def main(n_cpus, n_gpus, env_name,
    ...
    if use_tune_config:
        tune_config = {
            ...
            'evaluation_duration':tune.randint(5, 20),
            "critic_hiddens":tune.sample_from(
            ...
            'critic_lr': tune.uniform(0.0001, 0.02),
            'actor_lr': tune.uniform(0.0001, 0.02),
            'tau': tune.unifrom(0.005,0.05),
